  ...
  return (
    <section className="bg-[#0a0a0a] text-[#e7e7e7] flex flex-col gap-12 py-8 sm:p-16">
      <div className="text-center flex flex-col items-center justify-center gap-12">
        <h2
          data-aos="fade-down"
          className="font-amita text-[#dbae01] text-4xl font-bold"
        >
          {t("home6")}
        </h2>
        <p
          data-aos="fade-up"
          className="leading-7 font-poppins w-[95%] mx-auto"
        >
          {t("home7")}
        </p>
      </div>
      ...
      <div
        data-aos="fade-up"
        className="flex flex-col p-4 sm:p-0 items-center justify-center gap-5"
      >
        <p className="font-poppins text-lg text-[#dbae01]">{t("home8")}</p>
        ...
        >
          <Image
            className={`${style.animation} grayscale rounded-sm`}
            width={1000}
            height={0}
            src={"/magaa.png"}
            alt="maga"
