...
export const ContactFind = () => {
  return (
    <div className="flex flex-col gap-10 sm:gap-10">
          <div data-aos="fade-down" className="text-white flex text-center sm:text-start flex-col">
            <p className="mb-3 text-4xl font-amita font-bold">FIND US</p>
            <a
          ...
          <div className="flex flex-col gap-10 sm:gap-7">
            <div data-aos="fade-up" className="flex-col text-white text-center sm:text-start">
              ...
              <p>9RFR+92J, Mardanov brothers, Baku 1005</p>
            </div>
