...
const resources = {
  en: {
    translation: {
      ...
      about1:
        "In the tattoo business, being a good tattoo artist calls for a lot of skill and commitment to giving utterly the best kind of art which can rival others. The fact of the matter is, not everyone can become exceptional tattoo artists. The ones that have already made it in the business, such names have that something that makes them each tick and become the best that they are. So don’t let anyone fool you that desire alone is all that you need to get in the game. That said, what makes us stand out from the rest?",
  ...
  az: {
    translation: {
      ...
      home2:
        "Biz Bakıda yerləşirik, Azərbaycanda. Həftənin 7 günü 12PM - 1AM saatları arasında açığıqıq. Aşağıdakı formumuz vasitəsilə və ya zəng edərək randevu ala bilərsiniz",
      ...
      faq3: "Doğru dövmə dizaynını necə SEÇİM?",
      ...
      aftercare1:
        "Dövmənizin baxımı, əslində dövməni etməkdən daha vacibdir, hətta daha vacibdir. Zəhmət olmasa diqqət edin ki, dövmələr tamamilə sağalana qədər daimi deyil. Bu deməkdir ki, bir dövmə düzgün şəkildə sağalmazsa, sizin istədiyiniz kimi çıxmayabilir. Bu, bizim müştərilərimizə dövmənin mükəmməl şəkildə nəticələnməsi üçün lazım olan uyğun baxım addımlarını da verməyimizin səbəbidir.",
      aftercare2:
        "Əsasında eşitdiyimiz bir neçə yaygın yanlış anlayış və səhvlər var. Birincisi, bir dövmə ərazisini uzun müddət yumaq və dövmənin üzərinə losyon sürməməkdir. Losyonlar dövmələrin baxımı üçün yaxşı işləyirlər, amma məsələ, ətrağı tıxanmasıdır. Dövmənin sağalanması üçün havaya ehtiyacı var. Əgər dövmə üzərinə çoxlu miqdarlarda losyon istifadə olunarsa, infeksiyaya səbəb ola bilər. Losyon istifadə edirsinizsə, təxminən kiçik bir miqdar istifadə edin və losyonu uzun müddət üzərində saxlamaq əvəzinə onu yumaq və yenidən tətbiq edin.",
      aftercare3:
